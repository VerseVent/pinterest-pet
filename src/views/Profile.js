...
import CategoryContent from "../components/Profile/CategoryContent/CategoryContent";
import CategoryTab from "../components/Profile/CategoryItem/CategoryTab";
import { AppContext } from "../context/AppContext";

function Profile() {
  const { recommendedTags } = useContext(AppContext);
